...
@WebServlet(name = "HomWor4Servlet08_05", urlPatterns = {"/Servlet08_05"})
public class HomWor4Servlet08_05 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        response.getWriter().append("<a href='/Homework4_war_exploded/history'>Strona 4, historia odwiedzanych stron</a>");
    }
}
